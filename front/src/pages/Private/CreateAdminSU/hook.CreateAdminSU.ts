...
//services
import { createadminsu } from '../../../services/service.users';
...
export const usePageCreateAdminSU = () => {
    ...
    const onSubmit = async (data: TCreateAdminSU) => {
        ...
        console.log("# clave, confirm: ", clave, confirm)
        ...
        const resp = setResponseAdapter((await callEndpoint(createadminsu({ nombreusuario, nombres, apellidos, clave }))).data);
